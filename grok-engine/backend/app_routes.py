...
def reset_grok_sessions(ctx):
    """Clear only Grok monitor state; MercuryPro does not manage OpenAI registration."""
    adapter = ctx._get_registration_adapter("grok")
    return adapter.reset_registration_monitor()
