    ...
    def _open_private_context(self) -> None:
        ...
        if geo_profile.get("resolved"):
            self._progress(
                "init",
                (
                    "regional_profile_detected"
                    if self.using_camoufox
                    else "regional_profile_applied"
                ),
        ...
        if self.using_camoufox:
            ...
            # Playwright locale/timezone overrides here can conflict with the
            # fingerprint generated by Camoufox and increase risk challenges.
